  ...
  const profile = {
    0: {
      ...
      info: `
        ...
        <p style="padding-top: 16px;" class="modal-profile-text">Nadadhorn Dhamabutra founded Aesthetics Architects in 1992. He is the president of Aesthetics Group, a multidisciplinary ERM which include Aesthetics Creatects and Imagineers, Aesthetics Interior The Spa Studio and Aesthetics System.</p>
    ...
    3: {
      ...
      info: `
        ...
        <p style="padding-top: 16px;" class="modal-profile-text">Thunthamronk has been working with aesthectics architects for more than 25 years. He has been working on projects of various scales and types including general buildings to large scale complexes suck as 5 stars hotels, Luxury condominiums and Private Luxury Residences</p>
    ...
    4: {
      ...
      <p style="padding-top: 16px;" class="modal-profile-text">Manop Graduated with a Degree in Architecture. He has been with Aesthetics Architects since 1990.</p>
